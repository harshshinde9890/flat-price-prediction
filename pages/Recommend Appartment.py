...
st.set_page_config(page_title="Rcommend Appartments")

location_df=pickle.load(open('dataset/location.pkl', 'rb'))
...
st.title("Selection Location And Radius")

select_location=st.selectbox("Location",sorted(location_df.columns.to_list()))
